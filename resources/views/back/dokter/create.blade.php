    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tambah Data Dokter Baru</h3>
            ...
            <div class="card-body">
                <form action="/back/dokter/" method="post" autocomplete="off">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('spesialisasi') is-invalid @enderror"
                            placeholder="Masukkan Spesialisasi" name="spesialisasi" value="{{ old('spesialisasi') }}"
                            required />
                        @error('spesialisasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
...
@section('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            let oldData = "{{ old('jadwal_praktik') }}";

            if (oldData) {
                let items = oldData.split(', ');
                items.forEach(item => {
